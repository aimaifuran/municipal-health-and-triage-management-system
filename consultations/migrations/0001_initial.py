...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['patient', 'admitted', 'discharged'], name='consultatio_patient_5696ac_idx'), models.Index(fields=['doctor', 'discharged'], name='consultatio_doctor__c46d8c_idx')],
            },
        ),
    ]
