...
def render_discharge_summary_pdf(ctx: DischargeSummaryContext) -> bytes:
    ...
    footer_text = (
        "This document summarizes care provided at the municipal health facility "
        "listed above. The patient should follow prescribed medications and "
        "return immediately if symptoms worsen. This summary does not replace "
        "specialist referral records or hospital discharge papers when applicable."
    )
